...
class ProducerWineInfo extends Component {
    constructor(props) {
        super(props);
        this.state = {
            sUpdateId: '',
            ...
            sColumns: [
                ...
                },
                {
                    ...
                    title: '판매매장',
                    type : TYPE_NUMBER,
                    clickFunc: this.handleLinkPubList
                },
                {
                    name: 'id',
                    title: 'serial',
    ...
    handleLinkPubList = (value, dataItem, columnItem) => {
        this.props.history.push(`/pubmanager/brewery/${dataItem.id}`);
    }
...
ProducerWineInfo.propTypes = {};

ProducerWineInfo.defaultProps = {};
